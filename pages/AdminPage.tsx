                      ...
                      <td className="px-8 py-5 text-right">
                        {report.user !== currentUser.username && report.status === ReportStatus.PENDING && (
                          <div className="flex gap-2 justify-end">
                            <button onClick={() => handleStatusUpdate(report.id, report.user, ReportStatus.VERIFIED)} className="bg-green-600 text-white text-[9px] font-black uppercase px-3 py-1.5 rounded-xl shadow-md active:scale-95 transition-all">Verify</button>
                            <button onClick={() => handleStatusUpdate(report.id, report.user, ReportStatus.DECLINED)} className="bg-red-600 text-white text-[9px] font-black uppercase px-3 py-1.5 rounded-xl shadow-md active:scale-95 transition-all">Decline</button>
                          </div>
                        )}
                      </td>
                    </tr>
